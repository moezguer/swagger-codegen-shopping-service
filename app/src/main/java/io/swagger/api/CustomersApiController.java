...
public class CustomersApiController implements CustomersApi {
    ...
    public ResponseEntity<CustomerResponse> addCustomer(@ApiParam(value = "",
    ...
    public ResponseEntity<CartResponse> addItemToCart(@ApiParam(value = "",
    ...
    public ResponseEntity<Void> clearCart(@ApiParam(value = "Customer identifier.",
                                                    required = true) @PathVariable("customerid") String customerid) {
    ...
    public ResponseEntity<Void> deleteCustomer(@ApiParam(value = "Customer identifier.",
                                                         required = true) @PathVariable("customerid") String customerid) {
    ...
    public ResponseEntity<CartResponse> deleteItemFromCart(@ApiParam(value = "Customer identifier.",
                                                                     required = true) @PathVariable("customerid") String customerid,
    ...
    public ResponseEntity<CustomerResponse> findCustomerById(@ApiParam(value = "Customer identifier.",
                                                                       required = true) @PathVariable("customerid") String customerid) {
    ...
    public ResponseEntity<CartResponse> getAllItemsInCart(@ApiParam(value = "Customer identifier.",
                                                                    required = true) @PathVariable("customerid") String customerid) {
        final Cart cart = cartService.getCartByCustomerEmail(customerid);
        final CartResponse cartResponse = modelMapper.map(cart, CartResponse.class);
    ...
    public ResponseEntity<List<OrderResponse>> getAllOrdersOfCustomer(@ApiParam(value = "Customer identifier.",
                                                                                required = true) @PathVariable("customerid") String customerid) {
    ...
    public ResponseEntity<OrderResponse> getOrderOfCustomerById(@ApiParam(value = "Order identifier.",
                                                                          required = true) @PathVariable("orderid") UUID orderid) {
        final Order order = orderService.getOrderById(orderid);
        final OrderResponse orderResponse = modelMapper.map(order, OrderResponse.class);

        return new ResponseEntity<OrderResponse>(orderResponse, HttpStatus.OK);
    }

    public ResponseEntity<Void> importCustomersViaList(@ApiParam(value = "",
    ...
    public ResponseEntity<OrderResponse> placeOrder(@ApiParam(value = "Customer identifier.",
                                                              required = true) @PathVariable("customerid") String customerid) {
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(@ApiParam(value = "",
                                                                     required = true) @Valid @RequestBody CustomerRequest body) {
        final Customer customer = modelMapper.map(body, Customer.class);
    ...
    public ResponseEntity<CartResponse> updateItemQuantity(@ApiParam(value = "Customer identifier.",
                                                                     required = true) @PathVariable("customerid") String customerid,
                                                           @ApiParam(value = "Product identifier.",
                                                                     required = true) @PathVariable("productid") UUID productid,
